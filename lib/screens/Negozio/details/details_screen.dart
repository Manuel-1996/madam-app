...
class DetailsScreen extends StatefulWidget {
  @override
  _DetailsScreenNegozio createState() => _DetailsScreenNegozio();
  static String routeName = "/DetailsScreenNegozio";
  final NegoziPopolari negoziPop;
  DetailsScreen({Key key, @required this.negoziPop}) : super(key: key);
}

class _DetailsScreenNegozio extends State<DetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Body(negoziPop: widget.negoziPop),
    );
  }
